...
<div class="topnav">
    <div class="topbar">
        <div class="brand">
                <button class="iconbtn" id="openDrawer" title="Menu">☰</button>
        ...
        <div class="right">
            ...
            <div class="dropdown">
                <button class="iconbtn" id="notifBtn" title="Notifications">🔔 <span class="badge">3</span></button>
                <div class="menu" id="notifMenu">
                    ...
                    <div class="item"><b>DSS: High Delay Risk</b><small>Website Redesign</small></div>
                </div>
            </div>
    ...
    <div class="tabs">
        <a class="tab active" href="./dashboard-admin.html">Dashboard</a>
        <a class="tab" href="./clients.html">Clients</a>
        ...
        <a class="tab" href="./dss.html">DSS</a>
...
<div class="wrap page">
    ...
    <div class="grid grid-2">
        ...
        <div class="card soft">
            ...
            <button class="btn" onclick="location.href='./dss.html'">Open DSS</button>
            </div>
