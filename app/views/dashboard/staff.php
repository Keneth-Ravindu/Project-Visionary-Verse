...
<div class="topnav">
    <div class="topbar">
        <div class="brand">
            ...
            <div class="brand-sub">Team Member Portal</div>
            </div>
        </div>

        <div class="right">
            <span class="role-pill">Team Member</span>
            <div class="dropdown">
            <button class="iconbtn" id="notifBtn">🔔 <span class="badge">2</span></button>
            <div class="menu" id="notifMenu">
                <div class="item"><b>New task assigned</b><small>Keyword Research</small></div>
                <div class="item"><b>Task moved to Review</b><small>Ad Copy Draft</small></div>
            </div>
            </div>
    ...
    <div class="tabs">
        <a class="tab active" href="./dashboard-staff.html">Dashboard</a>
        <a class="tab" href="./projects.html">Projects</a>
        <a class="tab" href="./tasks.html">My Tasks</a>
        <a class="tab" href="./approvals.html">Deliverables</a>
...
<div class="drawer" id="drawer">
    <div class="drawer-panel">
        <div class="input-row" style="justify-content:space-between">
            <div class="brand">
            <img class="brand-logo-img" src="Project-Visionary-Verse/public/assets/img/logo.png" alt="Visionary Verse logo" />
            <div><div class="brand-name">Visionary Verse</div><div class="brand-sub">Team</div></div>
            </div>
...
<div class="wrap page">
    ...
    <div class="grid grid-2">
        <div class="card">
            ...
            <button class="btn" onclick="location.href='./tasks.html'">Open Tasks</button>
            </div>
        ...
        <div class="card soft">
            ...
            <button class="btn" onclick="location.href='./tasks.html'">+ Create / Update Tasks</button>
            <button class="btn btn-outline" onclick="location.href='./approvals.html'">Upload Deliverable</button>
