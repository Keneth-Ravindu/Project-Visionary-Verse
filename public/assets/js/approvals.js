document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll(".btnView").forEach(btn => {
        btn.addEventListener("click", async () => {
            ...
            try {
                const response = await fetch(`/pvv/public/approval/show/${id}`);
                ...
                const fileName = d.file_name ? d.file_name : "No file uploaded";
                ...
                let fileLink = "No file available";
                if (d.file_path && d.file_path.trim() !== "") {
                    fileLink = `<a href="${d.file_path}" target="_blank" rel="noopener">Open File</a>`;
                }
                ...
                if (viewInfo) {
                    viewInfo.innerHTML = `
                        ...
                        <strong>File:</strong> ${fileLink}<br>
